...
const Meta: React.FC = () => {
    return (
        <Head>
            ...
            <link rel="mask-icon" href="/favicon/safari-pinned-tab.svg?v=v0.0.1" color="#e95c59" />
            <link rel="shortcut icon" href="/favicon/favicon.ico?v=v0.0.1" />
            <meta name="msapplication-TileColor" content="#ffffff" />
            <meta name="theme-color" content="#e95c59" />
            <link rel="alternate" type="application/rss+xml" href="/feed.xml" />
            <meta name="description" content={'DANIE Website'} />
        </Head>
    );
};
