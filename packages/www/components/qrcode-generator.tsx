...
const QRCodeGenerator: React.FC = () => {
    ...
    if (error)
        ...
        composition = <h3 className="text-2xl md:text-3xl text-gray-700 pb-10">Connecting to DANIE...</h3>;
    else if (qrCode)
        composition = <>
        ...
        composition = isDev ? <pre>
            {JSON.stringify(key)}
        </pre> : <h3 className="text-2xl md:text-3xl text-gray-700 pb-10">Creating DANIE art...</h3>;
